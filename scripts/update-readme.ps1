...
function Build-Table($items, $maxImageWidth, $defaultImage) {
    ...
    foreach ($item in $items) {
        ...
        $desc = $descHtml + "<br>" + "<img src='https://img.shields.io/maven-central/v/$($item.'main-maven-id')?label=&style=for-the-badge&labelColor=444444&color=grey' alt='maven version'/>"
